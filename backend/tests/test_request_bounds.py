...
async def test_operator_input_is_refused_not_crashed(
    ...
    cases = [
        ...
        (
            "space, 21-char postcode",
            REFUSED,
            "POST",
            spaces,
            {"json": {"name": "S", "postal_code": "9" * 21}},
        ),
        (
            "space, NUL in postcode",
            REFUSED,
            "POST",
            spaces,
            {"json": {"name": "S", "postal_code": f"27{NUL}45"}},
        ),
        (
            "space, latitude past the pole",
            REFUSED,
            "POST",
            spaces,
            {"json": {"name": "S", "latitude": "1e400", "longitude": "0"}},
        ),
        (
            "space update, half a coordinate",
            REFUSED,
            "PUT",
            space,
            {"json": {"longitude": "-9.279799"}},
        ),
