...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "plan",
            sa.Enum("starter", "pro", "enterprise", name="org_plan"),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("owner", "admin", "member", name="member_role"),
    ...
    op.create_table(
        ...
        sa.Column(
            "hours_used", sa.Numeric(precision=5, scale=2), server_default="0", nullable=False
        ),
        sa.Column("hours_remaining", sa.Numeric(precision=5, scale=2), nullable=False),
        sa.Column(
            "status",
            sa.Enum("pending", "active", "cancelled", name="purchase_status"),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("pending", "confirmed", "cancelled", "completed", name="booking_status"),
            server_default="confirmed",
            nullable=False,
        ),
        sa.Column(
            "payment_method",
            sa.Enum("hourly", "package", name="payment_method"),
    ...
    op.create_index(
        "ix_bookings_room_id_start_time", "bookings", ["room_id", "start_time"], unique=False
    )
