  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-[#1A1A2E]">Espaços</h1>
          <p className="text-[#6B7280] text-sm mt-1">Gere os teus espaços e salas.</p>
        </div>
              ...
              <CardContent className="p-5 flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-2">
                    <h3 className="font-semibold text-[#1A1A2E]">{space.name}</h3>
